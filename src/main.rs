...
fn main() {
    ...
    let rubber = Material::new(Color::new(80, 0, 0), 10.0, [0.9, 0.1], 0.0, 0.0, 0.0);

    let ivory = Material::new(Color::new(100, 100, 100), 50.0, [0.6, 0.3], 0.6, 0.0, 0.0);

    let glass = Material::new(Color::new(255, 255, 255), 1450.0, [0.0, 1.0], 0.4, 0.6, 1.3);
